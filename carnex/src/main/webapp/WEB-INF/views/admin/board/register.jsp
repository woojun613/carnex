...
<script>
	...
	<section>
		<div class="tab-content">
			<form role="form" action="/admin/board/register" method="post">
				...
				<div class="content-wrap">
					<ul class="bd-reg-frm">
						<li>
							<p>제목 입력</p>
							<input id="title" type="text" name="title" placeholder="제목 입력" autofocus required class="input-frm input-sa">
						</li>
						<li>
							<p>작성자</p>
							<input type="text" name="writer" value="${session.user_nick}${staffsess.staff_id}" readonly class="input-frm input-sa">
						</li>
						<li>
							<p>첨부파일</p>
