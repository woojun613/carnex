...
// 	        }
			...
			if (confirm('정말 수정 하시겠습니까?') == true) {
				$('#modifyFrm').attr('action','/admin/goods/modify');
				$('#modifyFrm').submit();
			}
		});
	});
		    ...
		    <div class="content-header flex-between">
		        ...
		        <div class="sec-btn">
		        	<c:if test="${staffsess != null}">
   					<button id="modify-btn" type="submit">매물 수정</button>
   					</c:if>
					<a href="/admin/goods/goodsList?carType=&keyword=&car_status=">매물 목록</a>
		        </div>
		    </div>
		    <div class="content-wrap">
			    <form id="modifyFrm" action="" method="post" enctype="multipart/form-data" class="center-wrap">
			    	<input type="hidden" name="car_num" value="${modify.car_num }">
				    <ul class="gd-mod-frm">
				      <li>
				      	<p>자동차 제조사</p>
				        <input type="text" name="car_brand" value="${modify.car_brand }" required autofocus class="input-frm input-mb">
				      </li>
				      <li>
				      	<p>자동차 분류</p>
				      ...
				      <li>
				      	<p>자동차 모델</p>
				        <input type="text" name="car_model" value="${modify.car_model }" required class="input-frm input-mb">
				      </li>
				      <li>
				      	<p>자동차 가격</p>
				        <input type="number" name="car_price" value="${modify.car_price }" class="input-frm input-mb">
				      </li>
				      <li>
				      	<p>제목 입력</p>
				      	<div class="mb-frm-check">
					        <input type="text" name="car_title" value="${modify.car_title }" class="input-frm input-mb">
				      ...
				      <li>
				      	<p>차량 제원 입력</p>
				 	 	<div class="mb-frm-check">
					        <input type="text" name="car_subtitle" value="${modify.car_subtitle }" class="input-frm input-mb">
				      ...
				      <li>
				      	<p>사고 유무</p>
				 	 	<div class="mb-frm-check">
				        	<input type="number" name="car_accident" value="${modify.car_accident }" class="input-frm input-mb">
				      ...
				      <li><p>본문 설명</p></li>
				      <li>
						<textarea name="car_content" id="contents">${modify.car_content }</textarea>
						<script>
							var ckeditor_config = {
								width: '100%',
								height: '350px',
