...
<script src="/resources/ckeditor/ckeditor.js"></script>
	...
	<section>
		<form role="form" action="/static/board/register" method="post">
			...
			<ul class="bd-reg-frm">
				<li>
					...
					<div class="bd-side-btn">
						...
						<button type="submit" class="side-btn">작 성</button>
						</c:if>
						<a href="/static/board/list?num=1" class="side-btn">목 록</a>
					</div>
				</li>
				<li>
					<input id="title" type="text" name="title" placeholder="제목 입력" autofocus class="inputFrm input-mb input-title">
				</li>
				<li>
				...
				<li>
				<c:if test="${session != null or staffsess != null}">
					<button type="submit" class="btn btn-carnex">작 성</button>
				</c:if>
